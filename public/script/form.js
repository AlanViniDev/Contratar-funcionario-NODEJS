	...
	render: function(){
		return (
			<tr className="product">
				...
				<td><button className="btn btn-danger pull-right" onClick={this.onProductRemove}>Excluir</button></td>
            </tr>
		);
	}
});
			...
			<div className="row">
				...
				<form className="form-inline" role="form" onSubmit={this.handleSubmit}>
					<div className="form-group">
						<input type="text" placeholder="Nome" className="form-control" ref="author" required></input>
					</div>
					<div className="form-group">
						<input type="text" placeholder="Horas" className="form-control" ref="hours" required></input>
					</div>
